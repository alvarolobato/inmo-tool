...
| [D-038](docs/decisions/D-038-listing-staleness-surfacing.md) | Surface `last_seen_at` (not `last_fetched_at`) staleness on candidate card + property detail; bands fresh ≤7d / aging ≤21d / stale >21d; deduped property = FRESHEST active listing; label is a fact ("visto hace N días"), never "sold". |
