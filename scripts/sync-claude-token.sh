...
# docs/decisions/archive/D-025-oauth-single-refresher.md (archived
# source-project decision; the single-refresher rule it describes still
# applies here) and the Apr 2026 incident in
